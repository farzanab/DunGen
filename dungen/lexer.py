"""Functions to process strings/tokens for monster behaviours."""
...
token_types = [
	...
	(r'strength(?!\w)',    'STATS'),
	(r'maxhealth(?!\w)',   'STATS'),
	(r'maxphealth(?!\w)',  'STATS'),
	('player_distance(?!\w)', 'STATS'),
	
	(r'attack(?!\w)',      'ACTION'),
	(r'move_towards(?!\w)','ACTION'),
	(r'flee(?!\w)',        'ACTION'),
	(r'move_random(?!\w)', 'ACTION'),
	(r'move(?!\w)',        'ACTION'),
